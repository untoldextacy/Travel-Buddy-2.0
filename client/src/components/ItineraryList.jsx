      ...
      {itineraries.length > 0 ? (
        <ul className="list-none pl-0">
          {itineraries.map(itinerary => {
            ...
            if (!itinerary.id) {
              itinerary.id = Date.now(); // Assign a default id
            }
              ...
              >
                ...
                {hoveredId === itinerary.id && (
                  <>
                    ...
                    <div className="absolute left-0 top-full mt-6 bg-gray-800 text-white text-sm rounded p-2 shadow-lg whitespace-nowrap">
