    ...
    <div className="bg-white p-4 rounded shadow">
      ...
      <LoadScript googleMapsApiKey={process.env.REACT_APP_GOOGLE_MAPS_API_KEY}>
        <GoogleMap
          ...
          center={{ lat: itinerary.location.lat, lng: itinerary.location.lng }} // Center on the itinerary's location
          zoom={10}
        >
          <Marker position={{ lat: itinerary.location.lat, lng: itinerary.location.lng }} /> {/* Marker for the selected location */}
        </GoogleMap>
      </LoadScript>
